...
public class ABBint {
    ...
    //ToDo: implementar método remover
    public NO remover(NO root, int valor) {
    }

    //ToDo: implementar método maximo
    public int maximo(NO root) {
    }

    //ToDo: implementar método minimo
    public int minimo(NO root) {
    }
